...
export async function POST() {
  try {
    ...
    const call = await client.calls.create({
      twiml: '<Response><Say language="es-ES">Hola. Esta es una llamada de prueba del sistema de monitoreo de cargadores. El sistema funciona correctamente.</Say></Response>',
      to: toNumber,
      from: fromNumber
    });
